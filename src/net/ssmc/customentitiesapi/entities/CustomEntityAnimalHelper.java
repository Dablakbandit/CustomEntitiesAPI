...
public class CustomEntityAnimalHelper extends CustomEntityAgeableHelper{
	...
	public static void newGoalSelectorPathfinderGoalBreed(Object animal, double d){
		try{
			...
			Object o = pathfindergoalbreed.getConstructor(entityanimal, double.class).newInstance(entityanimal.cast(animal), d);
	...
	public static void newGoalSelectorPathfinderGoalFollowParent(Object animal, double d){
		try{
			Class<?> entityanimal = getNMSClass("EntityAnimal");
			Class<?> pathfindergoal = getNMSClass("PathfinderGoal");
			...
			Object o = pathfindergoalfollowparent.getConstructor(entityanimal, double.class).newInstance(entityanimal.cast(animal), d);
	...
	public static void removeGoalSelectorPathfinderGoalFollowParent(Object animal){
