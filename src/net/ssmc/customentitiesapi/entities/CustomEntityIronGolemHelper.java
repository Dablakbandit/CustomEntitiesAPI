...
public class CustomEntityIronGolemHelper extends CustomEntityGolemHelper{
	...
	public static void newGoalSelectorPathfinderGoalOfferFlower(Object irongolem){
		try{
			...
			Object o = pathfindergoalofferflower.getConstructor(entityirongolem).newInstance(entityirongolem.cast(irongolem));
	...
	public static void removeGoalSelectorPathfinderGoalOfferFlower(Object irongolem){
	...
	public static void setGoalSelectorDefaultPathfinderGoals(Object irongolem){
		...
		newGoalSelectorPathfinderGoalLookAtPlayer(irongolem, "EntityPlayer", 6.0F);
		...
		final Constructor cons = esm.getDeclaredConstructors()[0];
