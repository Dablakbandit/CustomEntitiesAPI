...
/**
 * A collection of static methods for creating a <code>CtMethod</code>. An
...
public class CtNewMethod {
	...
	/**
	 * Compiles the given source code and creates a method. The source code must
	 * include not only the method body but the whole declaration, for example,
	 * 
	 * <ul>
	 * 
	 * <pre>
	...
	/**
	 * Creates a public (non-static) method. The created method cannot be
	 * changed to a static method later.
	 * 
	 * @param returnType
	 ...
	 * @param body
	 *            the source text of the method body. It must be a block
	 *            surrounded by <code>{}</code>. If it is <code>null</code>, the
	...
	public static CtMethod make(int modifiers, CtClass returnType,
			String mname, CtClass[] parameters, CtClass[] exceptions,
	...
	/**
	 * Creates a copy of a method. This method is provided for creating a new
	 * method based on an existing method. This is a convenience method for
	 * calling {@link CtMethod#CtMethod(CtMethod, CtClass, ClassMap) this
	 * constructor}. See the description of the constructor for particular
	 * behavior of the copying.
	 * 
	 * @param src
	 *            the source method.
	 * @param declaring
	...
	/**
	 * Creates a copy of a method with a new name. This method is provided for
	 * creating a new method based on an existing method. This is a convenience
	 * method for calling {@link CtMethod#CtMethod(CtMethod, CtClass, ClassMap)
	 * this constructor}. See the description of the constructor for particular
	 * behavior of the copying.
	 * 
	 * @param src
	 *            the source method.
	 ...
	 */
	public static CtMethod abstractMethod(CtClass returnType, String mname,
			CtClass[] parameters, CtClass[] exceptions, CtClass declaring)
	...
	/**
	 * Creates a public getter method. The getter method returns the value of
	 * the specified field in the class to which this method is added. The
	 * created method is initially not static even if the field is static.
	 * Change the modifiers if the method should be static.
	 * 
	 * @param methodName
	...
	/**
	 * Creates a public setter method. The setter method assigns the value of
	 * the first parameter to the specified field in the class to which this
	 * method is added. The created method is not static even if the field is
	 * static. You may not change it to be static by <code>setModifiers()</code>
	 * in <code>CtBehavior</code>.
	 * 
	 * @param methodName
	...
	/**
	 * Creates a method forwarding to a delegate in a super class. The created
	 * method calls a method specified by <code>delegate</code> with all the
	...
	private static CtMethod delegator0(CtMethod delegate, CtClass declaring)
		...
		if (eattr != null)
			minfo.setExceptionsAttribute((ExceptionsAttribute) eattr.copy(cp,
					null));
	 ...
	 * <code>parameterTypes</code> into an array of <code>Object</code>. The
	 * returned value is also converted from the <code>Object</code> type to the
	 * type specified by <code>returnType</code>. Thus, the resulting method
	 * body is as follows:
	 * 
	 * <ul>
	 * 
	 ...
	 * <code>CtNewMethod.wrapped()</code>. Thus, it is easy to modify this
	 * program to produce a <code>StringVector</code> class, which is a vector
	...
	public static CtMethod wrapped(CtClass returnType, String mname,
			CtClass[] parameterTypes, CtClass[] exceptionTypes, CtMethod body,
			ConstParameter constParam, CtClass declaring)
			throws CannotCompileException {
