...
public class LineNumberAttribute extends AttributeInfo {
	...
	/**
	 * Returns <code>line_number_table_length</code>. This represents the number
	...
	/**
	 * Returns <code>line_number_table[i].start_pc</code>. This represents the
	 * index into the code array at which the code for a new line in the
	 * original source file begins.
	 * 
	 * @param i
	 *            the i-th entry.
	 */
	...
	/**
	 * Returns <code>line_number_table[i].line_number</code>. This represents
	...
	/**
	 * Returns the index into the code array at which the code for the specified
	 * line begins.
	 * 
	 * @param line
	 *            the line number.
	...
	/**
	 * Returns the index into the code array at which the code for the specified
	 * line (or the nearest line after the specified one) begins.
	 * 
	 * @param line
	 *            the line number.
	 * @return a pair of the index and the line number of the bytecode at that
	 *         index.
	 */
