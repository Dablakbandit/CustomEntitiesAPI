 ...
 * 
 * byte[] classfile = cfw
 * 		.end(AccessFlag.PUBLIC, thisClass, superClass, null, null);
 * </pre>
 * 
 * </blockquote>
 * 
...
public class ClassFileWriter {
	 ...
	 * @see AccessFlag
	 */
	public void end(DataOutputStream out, int accessFlags, int thisClass,
			int superClass, int[] interfaces, AttributeWriter aw)
			throws IOException {
		constPool.end();
		output.writeTo(out);
	...
	public static final class FieldWriter {
		 ...
		 * @see AccessFlag
		 */
		public void add(int accessFlags, String name, String descriptor,
				AttributeWriter aw) {
		 ...
		 * @see AccessFlag
		 */
		public void add(int accessFlags, int name, int descriptor,
				AttributeWriter aw) {
			++fieldCount;
			output.writeShort(accessFlags);
	...
	public static final class MethodWriter {
		 ...
		 *            attributes to the <code>Method_info</code>.
		 */
		public void begin(int accessFlags, int name, int descriptor,
				int[] exceptions, AttributeWriter aw) {
			++methodCount;
			output.writeShort(accessFlags);
			output.writeShort(name);
			output.writeShort(descriptor);
			...
			if (!isAbstract) {
				...
				output.writeBlank(12); // attribute_length, maxStack, maxLocals,
										// code_lenth
			}
		 ...
		 * @see Opcode
		 */
		public void addInvoke(int opcode, String targetClass,
		 ...
		 */
		public void addCatch(int startPc, int endPc, int handlerPc,
				int catchType) {
			++catchCount;
