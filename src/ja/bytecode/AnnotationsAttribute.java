 ...
 * 
 * <p>
 * The last statement is necessary if the class file was produced by ja or JDK
 * 1.4. Otherwise, it is not necessary.
 * 
...
public class AnnotationsAttribute extends AttributeInfo {
	...
	static class Parser extends Walker {
		...
		void enumMemberValue(int pos, int typeNameIndex, int constNameIndex)
				throws Exception {
			currentMember = new EnumMemberValue(typeNameIndex, constNameIndex,
					pool);
			super.enumMemberValue(pos, typeNameIndex, constNameIndex);
		}
