...
public class Descriptor {
	...
	/**
	 * Returns the <code>CtClass</code> objects representing the parameter types
	 * specified by the given descriptor.
	 * 
	 * @param desc
	 *            descriptor
	 * @param cp
	 *            the class pool used for obtaining a <code>CtClass</code>
	 *            object.
	 */
	...
	/**
	 * Returns the <code>CtClass</code> object representing the return type
	 * specified by the given descriptor.
	 * 
	 * @param desc
	 *            descriptor
	...
	private static int toCtClass(ClassPool cp, String desc, int i,
			CtClass[] args, int n) throws NotFoundException {
		int i2;
		String name;
