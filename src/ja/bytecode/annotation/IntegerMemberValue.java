...
public class IntegerMemberValue extends MemberValue {
	...
	/**
	 * Constructs an int constant value. The initial value is specified by the
	...
	/**
	 * Constructs an int constant value. Note that this constructor receives
	 * <b>the initial value as the second parameter</b> unlike the corresponding
	 * constructors in the sibling classes. This is for making a difference from
	 * the constructor that receives an index into the constant pool table as
	 * the first parameter. Note that the index is also int type.
	 * 
	 * @param value
	 *            the initial value.
	 */
