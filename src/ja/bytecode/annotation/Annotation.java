...
public class Annotation {
	...
	/**
	 * Constructs an annotation including no members. A member can be later
	 * added to the created annotation by <code>addMemberValue()</code>.
	 * 
	 * @param type
	 *            the index into the constant pool table. the entry at that
	 *            index must be the <code>CONSTANT_Utf8_Info</code> structure
	 ...
	 * represented by <code>clazz</code>. The values of the members are not
	 * specified.
	 * 
	 * @param cp
	 *            the constant pool table.
	 ...
	 * @param nameIndex
	 *            the index into the constant pool table. The entry at that
	 *            index must be a <code>CONSTANT_Utf8_info</code> structure.
	 ...
	 * the default value. The default value can be obtained from the annotation
	 * type.
	 * 
	 * @param name
	 *            the member name
	...
	public Object toAnnotationType(ClassLoader cl, ClassPool cp)
		...
		return AnnotationImpl.make(cl,
				MemberValue.loadClass(cl, getTypeName()), cp, this);
	}
	...
	/**
	 * Returns true if the given object represents the same annotation as this
	 * object. The equality test checks the member values.
	 */
