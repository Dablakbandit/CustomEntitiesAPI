...
public class LocalVariableAttribute extends AttributeInfo {
	...
	/**
	 * For each <code>local_variable_table[i].index</code>, this method
	 * increases <code>index</code> by <code>delta</code>.
	 * 
	 * @param lessThan
	...
	/**
	 * Returns <code>local_variable_table_length</code>. This represents the
	...
	/**
	 * Returns <code>local_variable_table[i].start_pc</code>. This represents
	 * the index into the code array from which the local variable is effective.
	 * 
	 * @param i
	 *            the i-th entry.
	 */
	...
	/**
	 * Returns <code>local_variable_table[i].length</code>. This represents the
	 * length of the code region in which the local variable is effective.
	 * 
	 * @param i
	 *            the i-th entry.
	 */
	 ...
	 * <code>local_variable_table[i].descriptor_index</code>. This represents
	 * the type descriptor of the local variable.
	 * <p>
	 * If this attribute represents a LocalVariableTypeTable attribute, this
	 * method returns the value of
	 * <code>local_variable_type_table[i].signature_index</code>. It represents
	...
	/**
	 * This method is equivalent to <code>descriptorIndex()</code>. If this
	 ...
	 * <p>
	 * If this attribute represents a LocalVariableTypeTable attribute, this
	 * method returns the type signature of the local variable specified by
	...
	/**
	 * This method is equivalent to <code>descriptor()</code>. If this attribute
	...
	/**
	 * Returns <code>local_variable_table[i].index</code>. This represents the
