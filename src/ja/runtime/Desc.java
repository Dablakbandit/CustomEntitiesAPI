 ...
 * This support class is required at runtime only if <code>$sig</code> or
...
public class Desc {
	...
	/**
	 * Interprets the given class name. It is used for implementing
	 * <code>$class</code>.
	 */
	...
	/**
	 * Interprets the given type descriptor representing a method signature. It
	 * is used for implementing <code>$sig</code>.
	 */
	...
	/**
	 * Interprets the given type descriptor. It is used for implementing
	 * <code>$type</code>.
	 */
	...
	private static Class[] getClassType(String desc, int descLen, int start,
			int num) {
		int end = start;
