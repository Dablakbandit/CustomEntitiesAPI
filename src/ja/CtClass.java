...
public abstract class CtClass {
	...
	/**
	 * If the value of this field is not null, then all class files modified by
	 * ja are saved under the directory specified by this variable. For example,
	 * if the value is <code>"./debug"</code>, then all class files are saved
	 * there. The directory name must not end with a directory separator such as
	 * <code>/</code>.
	 * 
	 * <p>
	...
	static {
		...
		voidType = new CtPrimitiveType("void", 'V', "java.lang.Void", null,
				null, Opcode.RETURN, 0, 0);
	 ...
	 * class file. However, for reflection, the type parameters are encoded into
	 * generic signatures and attached to a class file.
	 * 
	 ...
	 * ClassSignature cs = new ClassSignature(new TypeParameter[] { new TypeParameter(
	 * 		&quot;T&quot;) });
	 ...
	 * decoding, use <code>ja.Modifier</code>.
	 * 
	 * <p>
	 ...
	 * 
	 * @param mod
	 *            modifiers encoded by <code>ja.Modifier</code>
	 * @see Modifier
	 */
	 ...
	 * 
	 * @param list
	 *            a list of the <code>CtClass</code> objects representing
	...
	/**
	 * Returns an array containing <code>CtField</code> objects representing all
	 ...
	 * @see CtField#getSignature()
	 */
	public CtField getDeclaredField(String name, String desc)
	 ...
	 * <code>ja.bytecode.Descriptor</code>.
	 * 
	 * @param desc
	 *            method descriptor
	...
	/**
	 * Returns an array containing <code>CtMethod</code> objects representing
	 * all the non-private methods of the class. That array includes non-private
	 ...
	 * attribute. For dealing with attributes, see the <code>ja.bytecode</code>
	 * package. For example, the following expression returns all the attributes
	 * of a class file.
	 * 
	 * <ul>
	 * 
	 ...
	 * For dealing with attributes, see the <code>ja.bytecode</code> package.
	 * For example, the following expression adds an attribute <code>info</code>
	 * to a class file.
	 * 
	 * <ul>
	 * 
	 ...
	 * <code>CtMethod</code> and <code>CtConstructor</code> object in the class.
	 * 
	 * @param converter
	 ...
	 * file again and constructs another <code>CtClass</code> object
	...
	/**
	 * Writes a class file represented by this <code>CtClass</code> object in
	 * the current directory. Once this method is called, further modifications
	...
	/**
	 * Writes a class file represented by this <code>CtClass</code> object on a
	 ...
	 * @see #debugWriteFile(String)
	 */
	public void writeFile(String directoryName) throws CannotCompileException,
			IOException {
	 ...
	 */
	public void toBytecode(DataOutputStream out) throws CannotCompileException,
			IOException {
		throw new CannotCompileException("not a class");
	}
