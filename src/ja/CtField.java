...
public class CtField extends CtMember {
	...
	public CtField(CtField src, CtClass declaring)
		...
		java.util.ListIterator iterator = src.fieldInfo.getAttributes()
				.listIterator();
	...
	public boolean hasAnnotation(Class clz) {
		...
		AnnotationsAttribute ainfo = (AnnotationsAttribute) fi
				.getAttribute(AnnotationsAttribute.invisibleTag);
		AnnotationsAttribute ainfo2 = (AnnotationsAttribute) fi
	...
	public String getGenericSignature() {
		SignatureAttribute sa = (SignatureAttribute) fieldInfo
	 ...
	 * type variables. See {@link ja.CtClass#setGenericSignature(String)} for a
	 * code sample.
	 * 
	 * @param sig
	...
	public void setGenericSignature(String sig) {
		declaringClass.checkModify();
		fieldInfo.addAttribute(new SignatureAttribute(fieldInfo.getConstPool(),
				sig));
	}
	...
	public Object getConstantValue() {
		...
		default:
			throw new RuntimeException("bad tag: " + cp.getTag(index) + " at "
					+ index);
		}
	}
	 ...
	 * format. See {@link ja.bytecode.AttributeInfo}.
	 * 
	 * @param name
	 *            attribute name
	 */
	...
	public static abstract class Initializer {
		...
		abstract int compile(CtClass type, String name, Bytecode code,
				CtClass[] parameters, Javac drv) throws CannotCompileException;

		// produce codes for initialization
		abstract int compileIfStatic(CtClass type, String name, Bytecode code,
