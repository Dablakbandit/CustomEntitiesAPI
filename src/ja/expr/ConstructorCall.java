...
/**
 * Constructor call such as <code>this()</code> and <code>super()</code> within
 * a constructor body.
 * 
 * @see NewExpr
 */
public class ConstructorCall extends MethodCall {
	 ...
	 */
	protected ConstructorCall(int pos, CodeIterator i, CtClass decl,
			MethodInfo m) {
		super(pos, i, decl, m);
	}
	...
	public CtMethod getMethod() throws NotFoundException {
		throw new NotFoundException(
				"this is a constructor call.  Call getConstructor().");
	}
	...
	/**
	 * Returns true if the called constructor is not <code>this()</code> but
	 * <code>super()</code> (a constructor declared in the super class).
	 */
