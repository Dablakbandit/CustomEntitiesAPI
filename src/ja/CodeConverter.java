...
/**
 * Simple translator of method bodies (also see the <code>ja.expr</code>
 * package).
 * 
 * <p>
...
public class CodeConverter {
	...
	/**
	 * Modify a method body so that instantiation of the specified class is
	 * replaced with a call to the specified static method. For example,
	 * <code>replaceNew(ctPoint, ctSingleton, "createPoint")</code> (where
	 * <code>ctPoint</code> and <code>ctSingleton</code> are compile-time
	 * classes for class <code>Point</code> and class <code>Singleton</code>,
	 * respectively) replaces all occurrences of:
	 * 
	 * <ul>
	 * <code>new Point(x, y)</code>
	 * </ul>
	 * 
	 * in the method body with:
	 * 
	 * <ul>
	 * <code>Singleton.createPoint(x, y)</code>
	 * </ul>
	 * 
	 * <p>
	 ...
	 */
	public void replaceNew(CtClass newClass, CtClass calledClass,
			String calledMethod) {
	 ...
	 * <code>replaceNew(ctPoint, ctPoint2)</code> (where <code>ctPoint</code>
	 * and <code>ctPoint2</code> are compile-time classes for class
	 * <code>Point</code> and class <code>Point2</code>, respectively) replaces
	 * all occurrences of:
	 * 
	 * <ul>
	 * <code>new Point(x, y)</code>
	 ...
	 */
	public void redirectFieldAccess(CtField field, CtClass newClass,
			String newFieldname) {
	 ...
	 *            the name of the static method.
	 */
	public void replaceFieldRead(CtField field, CtClass calledClass,
			String calledMethod) {
	 ...
	 *            the name of the static method.
	 */
	public void replaceFieldWrite(CtField field, CtClass calledClass,
			String calledMethod) {
	 ...
	 * element from the array, this is replaced with a call to a static method
	 * with the array and the index as arguments, the return value is the value
	 ...
	 * <code>ArrayAccessReplacementMethodNames</code> which specifies the names
	 * of the method to be used for access for each type of array. For example
	 * reading from an <code>int[]</code> will require a different method than
	 * if writing to an <code>int[]</code>, and writing to a <code>long[]</code>
	 * will require a different method than if writing to a <code>byte[]</code>.
	 ...
	 * <code>DefaultArrayAccessReplacementMethodNames</code> has been provided
	 ...
	 * @param names
	 *            contains the names of the methods to replace the different
	...
	public void replaceArrayAccess(CtClass calledClass,
		...
		transformers = new TransformAccessArrayField(transformers,
				calledClass.getName(), names);
	}
	 ...
	 * modified. Only the method name is changed. The substituted method must
	 * have the same signature that the original one has. If the original method
	 * is a static method, the substituted method must be static.
	 * 
	 * @param origMethod
	 *            original method
	 * @param substMethod
	...
	public void redirectMethodCall(CtMethod origMethod, CtMethod substMethod)
		...
		if (Modifier.isStatic(mod1) != Modifier.isStatic(mod2)
				...
				|| origMethod.getDeclaringClass().isInterface() != substMethod
	...
	/**
	 * Insert a call to another method before an existing method call. That
	 * "before" method must be static. The return type must be <code>void</code>
	 * . As parameters, the before method receives the target object and all the
	 * parameters to the originally invoked method. For example, if the
	 * originally invoked method is <code>move()</code>:
	 * 
	 * <ul>
	 * 
	 * <pre>
	...
	/**
	 * Inserts a call to another method after an existing method call. That
	 * "after" method must be static. The return type must be <code>void</code>.
	 * As parameters, the after method receives the target object and all the
	 * parameters to the originally invoked method. For example, if the
	 * originally invoked method is <code>move()</code>:
	 * 
	 * <ul>
	...
	public interface ArrayAccessReplacementMethodNames {
		 ...
		 *         <code>(Ljava/lang/Object;I)C</code> to replace reading from a
		 *         char[].
		 */
		String charRead();
		...
		/**
		 * Returns the name of a static method with the signature
		 * <code>(Ljava/lang/Object;I)D</code> to replace reading from a
		 * double[].
		 */
		String doubleRead();
		...
		/**
		 * Returns the name of a static method with the signature
		 * <code>(Ljava/lang/Object;ID)V</code> to replace writing to a
		 * double[].
		 */
		String doubleWrite();
		...
		/**
		 * Returns the name of a static method with the signature
		 * <code>(Ljava/lang/Object;I)F</code> to replace reading from a
		 * float[].
		 */
		String floatRead();
		...
		/**
		 * Returns the name of a static method with the signature
		 * <code>(Ljava/lang/Object;I)Ljava/lang/Object;</code> to replace
		 * reading from a Object[] (or any subclass of object).
		 */
		String objectRead();

		/**
		 * Returns the name of a static method with the signature
		 * <code>(Ljava/lang/Object;ILjava/lang/Object;)V</code> to replace
		 * writing to a Object[] (or any subclass of object).
		 */
		String objectWrite();

		/**
		 * Returns the name of a static method with the signature
		 * <code>(Ljava/lang/Object;I)S</code> to replace reading from a
		 * short[].
		 */
		String shortRead();
	 ...
	 * <code>ArrayAccessReplacementMethodNames</code> interface giving default
	 * values for method names to be used for replacing accesses to array
	 * elements.
	 * 
	 * @author <a href="kabir.khan@jboss.com">Kabir Khan</a>
	 * @version $Revision: 1.16 $
	 */
	public static class DefaultArrayAccessReplacementMethodNames implements
			ArrayAccessReplacementMethodNames {
		/**
		 * Returns "arrayReadByteOrBoolean" as the name of the static method
		 * with the signature (Ljava/lang/Object;I)B to replace reading from a
		 * byte[].
		 */
		...
		/**
		 * Returns "arrayWriteByteOrBoolean" as the name of the static method
		 * with the signature (Ljava/lang/Object;IB)V to replace writing to a
		 * byte[].
		 */
		...
		/**
		 * Returns "arrayReadChar" as the name of the static method with the
		 * signature (Ljava/lang/Object;I)C to replace reading from a char[].
		 */
		...
		/**
		 * Returns "arrayWriteChar" as the name of the static method with the
		 * signature (Ljava/lang/Object;IC)V to replace writing to a byte[].
		 */
		...
		/**
		 * Returns "arrayReadDouble" as the name of the static method with the
		 * signature (Ljava/lang/Object;I)D to replace reading from a double[].
		 */
		...
		/**
		 * Returns "arrayReadFloat" as the name of the static method with the
		 * signature (Ljava/lang/Object;I)F to replace reading from a float[].
		 */
		...
		/**
		 * Returns "arrayWriteFloat" as the name of the static method with the
		 * signature (Ljava/lang/Object;IF)V to replace writing to a float[].
		 */
		...
		/**
		 * Returns "arrayReadInt" as the name of the static method with the
		 * signature (Ljava/lang/Object;I)I to replace reading from a int[].
		 */
		...
		/**
		 * Returns "arrayWriteInt" as the name of the static method with the
		 * signature (Ljava/lang/Object;II)V to replace writing to a int[].
		 */
		...
		/**
		 * Returns "arrayReadLong" as the name of the static method with the
		 * signature (Ljava/lang/Object;I)J to replace reading from a long[].
		 */
		...
		/**
		 * Returns "arrayWriteLong" as the name of the static method with the
		 * signature (Ljava/lang/Object;IJ)V to replace writing to a long[].
		 */
		...
		/**
		 * Returns "arrayReadObject" as the name of the static method with the
		 * signature (Ljava/lang/Object;I)Ljava/lang/Object; to replace reading
		 * from a Object[] (or any subclass of object).
		 */
		 ...
		 * signature (Ljava/lang/Object;ILjava/lang/Object;)V to replace writing
		 * to a Object[] (or any subclass of object).
		 */
		...
		/**
		 * Returns "arrayReadShort" as the name of the static method with the
		 * signature (Ljava/lang/Object;I)S to replace reading from a short[].
		 */
		...
		/**
		 * Returns "arrayWriteShort" as the name of the static method with the
		 * signature (Ljava/lang/Object;IS)V to replace writing to a short[].
		 */
