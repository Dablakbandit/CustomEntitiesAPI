...
public final class CtConstructor extends CtBehavior {
	 ...
	 * class and the superclass that the created constructor is added to. This
	 ...
	 * <code>ja.CtConstructor(CtClass[],CtClass)</code>.
	 * 
	 * @since 3.5
	 */
	 ...
	 * of the class declaring this constructor. If this object represents a
	 * class initializer, then this method returns <code>"&lt;clinit&gt;"</code>
	 * .
	 */
	...
	/**
	 * Returns true if the constructor (or static initializer) is the default
	 * one. This method returns true if the constructor takes some arguments but
	 * it does not perform anything except calling <code>super()</code> (the
		...
		try {
			...
			return op0 == Opcode.RETURN // empty static initializer
					|| (op0 == Opcode.ALOAD_0
							...
							&& it.byteAt(it.next()) == Opcode.RETURN && !it
								.hasNext());
		} catch (BadBytecode e) {
		}
		return false;
	 ...
	 * This method returns false if it calls another constructor of this class
	 * by <code>this()</code>.
	 */
	 ...
	 * 
	 * @param src
	 *            the source code representing the constructor body. It must be
	 *            a single statement or block. If it is <code>null</code>, the
	 *            substituted constructor body does nothing except calling
	 *            <code>super()</code>.
	 */
	...
	public void setBody(CtConstructor src, ClassMap map)
			throws CannotCompileException {
		setBody0(src.declaringClass, src.methodInfo, declaringClass,
				methodInfo, map);
	}

	/**
	 * Inserts bytecode just after another constructor in the super class or
	 * this class is called. It does not work if this object represents a class
	 * initializer.
	 * 
	 * @param src
	...
	/*
	 * This method is called by addCatch() in CtBehavior. super() and this()
	 * must not be in a try statement.
	 */
	...
	/**
	 * Makes a copy of this constructor and converts it into a method. The
	 * signature of the mehtod is the same as the that of this constructor. The
	 ...
	 * constructor accesses a field, the class declaring the resulting method
	...
	/**
	 * Makes a copy of this constructor and converts it into a method. The
	 * signature of the method is the same as the that of this constructor. The
	 * return type is <code>void</code>. The resulting method must be appended
	 * to the class specified by <code>declaring</code>. If this constructor is
	 * a static initializer, the resulting method takes no parameter.
	 * 
	 ...
	 * obviously true if the second parameter <code>declaring</code> is the same
	 * as the class declaring this constructor). If the constructor accesses a
	 * field, the class declaring the resulting method must also declare a field
	 * with the same name and type.
	 * 
	 * @param name
	 *            the name of the resulting method.
	 * @param declaring
	 *            the class declaring the resulting method. It is normally the
	 *            same as the class declaring this constructor.
	 * @param map
	 *            the hash table associating original class names with
	 *            substituted names. The original class names will be replaced
	 *            while making a copy. <code>map</code> can be <code>null</code>
	 *            .
	 */
		...
		try {
			...
			if (pos >= 0) {
				...
				while (true) {
					it.next();
					if (it.isParameter())
						iterator.writeByte(it.is2byte() ? Opcode.POP2
								: Opcode.POP, pos++);
					else
						break;
				}
