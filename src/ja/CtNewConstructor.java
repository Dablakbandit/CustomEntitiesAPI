 ...
 * and append code snippet to the body of the class initializer obtained by
...
public class CtNewConstructor {
	...
	/**
	 * Compiles the given source code and creates a constructor. The source code
	 * must include not only the constructor body but the whole declaration.
	 * 
	 * @param src
	 *            the source text.
	 * @param declaring
	 ...
	 * @param body
	 *            the source text of the constructor body. It must be a block
	...
	public static CtConstructor make(CtClass[] parameters,
			CtClass[] exceptions, String body, CtClass declaring)
			throws CannotCompileException {
		try {
	 ...
	 * {@link CtConstructor#CtConstructor(CtConstructor, CtClass, ClassMap) this
	...
	/**
	 * Creates a public constructor that only calls a constructor in the super
	 ...
	 * insert initialization code in constructor bodies.
	 * 
	 * @param parameters
	 *            parameter types
	 * @param exceptions
	 ...
	 * Creates a public constructor that only calls a constructor in the super
	 * class. The created constructor receives parameters specified by
	 * <code>parameters</code> and calls the super's constructor with those
	 * parameters.
	 * 
	 * @param parameters
	 *            parameter types
	 ...
	 * array of <code>Object</code>. The signature of the super's constructor
	 * must be:
	 * 
	 * <ul>
	 * <code>constructor(Object[] params, &lt;type&gt; cvalue)
	 * </code>
	 * </ul>
	 * 
	 * <p>
	 ...
	 * 
	 * <ul>
	 * <code>constructor(Object[] params)</code>
	 * </ul>
	 * 
	 * <p>
	 ...
	 * in the form of an array of <code>Object</code>. The method specified by
	 * <code>body</code> must have the signature shown below:
	 * 
	 * <ul>
	 ...
	 * @param howto
	 *            how to pass parameters to the super-class' constructor (
	 *            <code>PASS_NONE</code>, <code>PASS_ARRAY</code>, or
	 *            <code>PASS_PARAMS</code>)
	 * @param body
	 *            appended body (may be <code>null</code>). It must be not a
	 ...
	 */
	public static CtConstructor make(CtClass[] parameters,
			CtClass[] exceptions, int howto, CtMethod body,
			ConstParameter cparam, CtClass declaring)
			throws CannotCompileException {
		return CtNewWrappedConstructor.wrapped(parameters, exceptions, howto,
				body, cparam, declaring);
	}
}
