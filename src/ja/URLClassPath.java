...
public class URLClassPath implements ClassPath {
	 ...
	 * is "org.ja." and a requested class is "org.ja.test.Main", then the given
	 * URL is used for loading that class. The <code>URLClassPath</code> obtains
	 * a class file from:
	 * 
	 * <ul>
	 * 
	 * <pre>
	 * http://www.ja.org:80/java/classes/org/ja/test/Main.class
	 * </pre>
	 * 
	 * </ul>
	 * 
	 * <p>
	 * Here, we assume that <code>host</code> is "www.ja.org", <code>port</code>
	 * is 80, and <code>directory</code> is "/java/classes/".
	 * 
	 * <p>
	 ...
	 *            port number
	 * @param directory
	 *            directory name ending with "/". It can be "/" (root
	 *            directory). It must start with "/".
	 * @param packageName
	 *            package name. It must end with "." (dot).
	 */
	public URLClassPath(String host, int port, String directory,
			String packageName) {
		hostname = host;
		this.port = port;
	 ...
	 */
	public static byte[] fetchClass(String host, int port, String directory,
