...
public final class CtMethod extends CtBehavior {
	 ...
	 */
	public CtMethod(CtClass returnType, String mname, CtClass[] parameters,
			CtClass declaring) {
		this(null, declaring);
	 ...
	 * <code>ja.CtMethod.setBody(String)</code>.
	 * 
	 * @since 3.5
	 */
	public String getLongName() {
		return getDeclaringClass().getName() + "." + getName()
				+ Descriptor.toString(getSignature());
	}
	...
	public void setWrappedBody(CtMethod mbody, ConstParameter constParam)
		...
		Bytecode code = CtNewWrappedMethod.makeBody(clazz,
				clazz.getClassFile2(), mbody, params, retType, constParam);
