...
public interface MethodHandler {
	/**
	 * Is called when a method is invoked on a proxy instance associated with
	 * this handler. This method must process that method invocation.
	 * 
	 * @param self
	 *            the proxy instance.
	 * @param thisMethod
	 ...
	 *            interface.
	 * @param proceed
	 *            the forwarder method for invoking the overridden method. It is
	 *            null if the overridden method is abstract or declared in the
	 *            interface.
	 * @param args
