 ...
 * {@link ProxyFactory}. It must be used when serialising proxies created from a
 * proxy factory configured with {@link ProxyFactory#useWriteReplace} set to
 * false. Subsequent deserialization of the serialized data must employ a
 * {@link ProxyObjectInputStream}
 * 
 * @author Andrew Dinn
 */
