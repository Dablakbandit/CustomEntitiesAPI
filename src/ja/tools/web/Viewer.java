 ...
 * 
 * <ul>
 * <code>% java ja.tools.web.Viewer <i>host port</i> Main arg1, ...</code>
 * </ul>
 * 
 * <p>
...
public class Viewer extends ClassLoader {
	...
	public static void main(String[] args) throws Throwable {
		if (args.length >= 3) {
			...
			System.err
					.println("Usage: java ja.tools.web.Viewer <host> <port> class [args ...]");
	}
	...
	/**
	 * Finds the specified class. The implementation in this class fetches the
