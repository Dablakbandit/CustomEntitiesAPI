 ...
 * 
 * <p>
 * <b>Note:</b> although this class is included in the ja API, it is provided as
 * a sample implementation of the web server using ja. Especially, there might
 * be security flaws in this server. Please use this with YOUR OWN RISK.
 */
public class Webserver {
	 ...
	 * the directory separator such as "/". (For portability, "/" should be used
	 * as the directory separator. ja automatically translates "/" into a
	...
	public static void main(String[] args) throws IOException {
		if (args.length == 1) {
			...
			System.err
					.println("Usage: java ja.tools.web.Webserver <port number>");
	}
	...
	/**
	 * Requests the web server to use the specified <code>ClassPool</code>
	...
	/**
	 * Adds a translator, which is called whenever a client requests a class
	 * file.
	 * 
	 * @param cp
	...
	private boolean letUsersSendClassfile(OutputStream out, String filename,
			int length) throws IOException, BadHttpRequest {
		if (classPool == null)
			return false;
