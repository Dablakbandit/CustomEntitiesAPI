...
public class AppletServer extends Webserver {
	 ...
	 *            port number
	 */
	public AppletServer(String port) throws IOException, NotFoundException,
	 ...
	 *            port number
	 */
	public AppletServer(int port) throws IOException, NotFoundException,
			CannotCompileException {
	 ...
	 */
	public AppletServer(int port, ClassPool src) throws IOException,
	...
	private void processRMI(InputStream ins, OutputStream outs)
		...
		Object rvalue = null;
		try {
			ExportedObject eo = (ExportedObject) exportedObjects
					.elementAt(objectId);
	...
	private Object[] readParameters(ObjectInputStream in) throws IOException,
