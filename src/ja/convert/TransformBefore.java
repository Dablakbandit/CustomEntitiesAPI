...
public class TransformBefore extends TransformCall {
	...
	public TransformBefore(Transformer next, CtMethod origMethod,
			CtMethod beforeMethod) throws NotFoundException {
	...
	protected int match(int c, int pos, CodeIterator iterator, int typedesc,
	...
	private void makeCode2(Bytecode save, Bytecode load, int i, int n,
			CtClass[] paramTypes, int var) {
		if (i < n) {
