 ...
 * It is necessary for compiling a method in an inner class.
 */
public class AccessorMaker {
	 ...
	 * @param accDesc
	 *            the descriptor of the accessor method. The first parameter
	 *            type is <code>clazz</code>. If the private method is static,
	...
	public String getMethodAccessor(String name, String desc, String accDesc,
			MethodInfo orig) throws CompileError {
