...
public abstract class CustomEntity {
	...
	public CustomEntity(String name) {
		...
		try {
			cp.appendClassPath(new LoaderClassPath(CustomEntity.class
					.getClassLoader()));
			try {
				...
				CtClass ces = cp
						.getAndRename(
								"me.dablakbandit.customentitiesapi.entities.CustomEntityHelper",
								"temp.CustomEntityHelper");
				ces.toClass();
			}
		...
		try {
			...
			cp.importPackage("net.minecraft.server." + NMSUtils.getVersion()
					+ "NBTTagCompound");
			methods.add("public void b(NBTTagCompound nbt){" + "super.a(nbt);"
					+ "nbt.setBoolean(\"pushable\", this.pushable);" + "}");
			methods.add("public void a(NBTTagCompound nbt){" + "super.a(nbt);"
			...
			methods.add("public void g(double d0, double d1, double d2){"
					+ "if(this.pushable){" + "super.g(d0, d1, d2);" + "}" + "}");
			methods.add("public void setPushable(){" + "this.pushable=true;"
					+ "}");
			methods.add("public void setUnpushable(){" + "this.pushable=false;"
					+ "}");
			methods.add("public boolean getUnpushable(){"
					+ "return !this.pushable;" + "}");
			methods.add("public boolean getPushable(){"
					+ "return this.pushable;" + "}");
			methods.add("public double getLocationX(){" + "return this.locX;"
					+ "}");
			methods.add("public double getLocationY(){" + "return this.locY;"
					+ "}");
			methods.add("public double getLocationZ(){" + "return this.locZ;"
					+ "}");
			methods.add("public float getLocationYaw(){" + "return this.yaw;"
					+ "}");
	...
	public final void spawnEntity(Location location) {
		...
		try {
			...
			Object newentity = helper.getMethod("createEntity", Object.class,
					Class.class, double.class, double.class, double.class,
	...
	public void teleportTo(Location location) {
		try {
			entity.getClass()
					.getMethod("teleportTo", location.getClass(), boolean.class)
					.invoke(entity, location, false);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public int getAirTicks() {
		try {
			return (int) entity.getClass().getMethod("getAirTicks")
					.invoke(entity);
		} catch (Exception e) {
			e.printStackTrace();
			return 0;
	...
	public UUID getUUID() {
		try {
			return (UUID) entity.getClass().getMethod("getUniqueID")
					.invoke(entity);
		} catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	public void setAirTicks(int i) {
		try {
			entity.getClass().getMethod("setAirTicks", int.class)
					.invoke(entity, i);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void setInvisible(boolean flag) {
		try {
			entity.getClass().getMethod("setInvisible", boolean.class)
					.invoke(entity, flag);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		try {
			entity.getClass()
					.getMethod("setLocation", double.class, double.class,
							double.class).invoke(entity, d0, d1, d2);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void setOnFire(int i) {
		try {
			entity.getClass().getMethod("setOnFire", int.class)
					.invoke(entity, i);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void setPositionRotation(double d0, double d1, double d2, float f1,
			float f2) {
		try {
			entity.getClass()
					.getMethod("setPositionRotation", double.class,
							double.class, double.class, float.class,
							float.class).invoke(entity, d0, d1, d2, f1, f2);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void setSneaking(boolean flag) {
		try {
			entity.getClass().getMethod("setSneaking", boolean.class)
					.invoke(entity, flag);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public Entity getBukkitEntity() {
		try {
			return (Entity) entity.getClass().getMethod("getBukkitEntity")
					.invoke(entity);
		} catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	public void setDamageable(boolean value) {
		if (value) {
			try {
				helper.getMethod("setDamageable", Object.class).invoke(null,
						entity);
			} catch (Exception e) {
				e.printStackTrace();
			}
			...
			try {
				helper.getMethod("setUndamageable", Object.class).invoke(null,
						entity);
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public void setDamageable() {
		try {
			helper.getMethod("setDamageable", Object.class)
					.invoke(null, entity);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public boolean getDamageable() {
		try {
			return (boolean) helper.getMethod("getDamageable", Object.class)
					.invoke(null, entity);
		} catch (Exception e) {
			e.printStackTrace();
			return true;
	...
	public final boolean getPushable() {
		try {
			return (boolean) entity.getClass().getMethod("getPushable")
					.invoke(entity);
		} catch (Exception e) {
			e.printStackTrace();
			return true;
	...
	public final void setAbleToMove() {
		try {
			helper.getMethod("setAbleToMove", Object.class)
					.invoke(null, entity);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public final void setAbleToMove(double d) {
		try {
			helper.getMethod("setAbleToMove", Object.class, double.class)
					.invoke(null, entity, d);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public final void setUnableToMove() {
		try {
			helper.getMethod("setUnableToMove", Object.class).invoke(null,
					entity);
		} catch (Exception e) {
			e.printStackTrace();
		}
