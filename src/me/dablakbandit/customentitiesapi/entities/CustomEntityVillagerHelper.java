...
public class CustomEntityVillagerHelper extends CustomEntityAgeableHelper{
	...
	public static void setGoalSelectorDefaultPathfinderGoals(Object villager){
		...
		newGoalSelectorPathfinderGoalAvoidPlayer(villager, "EntityZombie", 8.0F, 0.6D, 0.6D);
		...
		newGoalSelectorPathfinderGoalInteract(villager, "EntityHuman", 3.0F, 1.0F);
		newGoalSelectorPathfinderGoalInteract(villager, "EntityVillager", 3.0F, 1.0F);
		newGoalSelectorPathfinderGoalRandomStroll(villager, 0.6D);
		newGoalSelectorPathfinderGoalLookAtPlayer(villager, "EntityInsentient", 8.0F);
	}

	public static void newGoalSelectorPathfinderGoalTradeWithPlayer(Object villager){
		try{
			...
			Object o = pathfindergoaltradewithplayer.getConstructor(entityvillager).newInstance(entityvillager.cast(villager));
	...
	public static void removeGoalSelectorPathfinderGoalTradeWithPlayer(Object villager){
		removeGoalSelectorPathFinderGoal(villager, "PathfinderGoalTradeWithPlayer");
	}
	
	public static void newGoalSelectorPathfinderGoalLookAtTradingPlayer(Object villager){
		try{
			Class<?> entityvillager = getNMSClass("EntityVillager");
			Class<?> pathfindergoal = getNMSClass("PathfinderGoal");
			...
			Object o = pathfindergoallookattradingplayer.getConstructor(entityvillager).newInstance(entityvillager.cast(villager));
	...
	public static void removeGoalSelectorPathfinderGoalLookAtTradingPlayer(Object villager){
		removeGoalSelectorPathFinderGoal(villager, "PathfinderGoalLookAtTradingPlayer");
	}
	...
	public static void newGoalSelectorPathfinderGoalMakeLove(Object villager){
		try{
			...
			Object o = pathfindergoalmakelove.getConstructor(entityvillager).newInstance(entityvillager.cast(villager));
	...
	public static void newGoalSelectorPathfinderGoalTakeFlower(Object villager){
		try{
			...
			Object o = pathfindergoaltakeflower.getConstructor(entityvillager).newInstance(entityvillager.cast(villager));
	...
	public static void removeGoalSelectorPathfinderGoalTakeFlower(Object villager){
		removeGoalSelectorPathFinderGoal(villager, "PathfinderGoalTakeFlower");
	}
	
	public static void newGoalSelectorPathfinderGoalPlay(Object villager, double d){
		try{
			Class<?> entityvillager = getNMSClass("EntityVillager");
			Class<?> pathfindergoal = getNMSClass("PathfinderGoal");
			...
			Object o = pathfindergoalplay.getConstructor(entityvillager, double.class).newInstance(entityvillager.cast(villager), d);
