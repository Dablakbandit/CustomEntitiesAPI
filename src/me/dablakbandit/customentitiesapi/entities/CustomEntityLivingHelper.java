...
public class CustomEntityLivingHelper extends CustomEntityHelper{
	...
	public static void setIAttribute(Object living, String iattributestring, double value){
		try{
			...
			Object attributeinstance = entityliving.getMethod("getAttributeInstance", iattribute).invoke(living, iattrib);
			attributeinstance.getClass().getMethod("setValue", double.class).invoke(attributeinstance, value);
		}catch(Exception e){
			e.printStackTrace();
		}
	}
